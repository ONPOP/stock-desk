...
// [재설계] 칩/리스트 비주얼만. [보존] useState 필터·types 메모·DisclosureItem·정렬·링크.
  ...
  return (
    <div className="space-y-3">
      ...
      <ul className="divide-y">
        {filtered.map((d, i) => (
          <li key={`${d.source}-${d.url}-${i}`} className="py-3">
            <div className="flex items-start gap-2">
              <Badge variant="outline" className="shrink-0 border-0 bg-accent text-[10px] text-accent-foreground">
